...
import com.ntc.thumbnailer.thumbnailers.Thumbnailer;
import com.ntc.thumbnailer.util.ChainedHashMap;
import com.ntc.thumbnailer.util.IOUtil;
import com.ntc.thumbnailer.util.StringUtil;
...
public class ThumbnailerManager implements Thumbnailer, ThumbnailerConstants {
	...
	private static Logger mLog = LoggerFactory.getLogger(ThumbnailerManager.class);
