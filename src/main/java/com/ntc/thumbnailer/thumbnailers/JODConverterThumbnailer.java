...
public abstract class JODConverterThumbnailer extends AbstractThumbnailer {
	...
	protected static Logger mLog = LoggerFactory.getLogger(JODConverterThumbnailer.class);
	 ...
	 */
	private static int OOO_PORT = 8100;
...
//	}
    ...
    public JODConverterThumbnailer(int port) {
        OOO_PORT = port;
		ooo_thumbnailer = new OpenOfficeThumbnailer();
		mimeTypeDetector = new MimeTypeDetector();
		temporaryFilesManager = new TemporaryFilesManager();
